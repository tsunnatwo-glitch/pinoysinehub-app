...
export default function App() {
 ...
 const [userProfile, setUserProfile] = useState<UserProfile>(() => userService.createFreshGuest());
...
useEffect(() => {
  ...
  // Require a real Firebase account before playing
  if (!authReady || userProfile.isAnonymous || !userProfile.email?.trim()) {
    alert('Kailangan mong mag-sign up o mag-log in muna bago manood.');
    setIsAuthOpen(true);
    return;
  }
